...
#changed interpreter to 3.10.12 by refering to ~/.pyenv/versions/3.10.12/bin/python3
#Unable to install grpcio using pip install grpcio #pip3 install --upgrade pip #python3 -m pip install --upgrade setuptools #pip3 install --no-cache-dir  --force-reinstall -Iv grpcio
...
#download google service account json file from google cloud console and rename as secrets.json and keep in .streamlit folder
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = ".streamlit/secrets.json"

#in ~/.streamlit folder create secrets.toml file and keep the following 3 lines
#GCP_PROJECT_ID = ""
#ASTRA_DB_TOKEN= ""
#ASTRA_API_ENDPOINT= ""
...
def main():
    ...
    with st.sidebar:
        ...
        st.download_button(
            ...
            data=open('example-outfit.jpeg', 'rb').read(),
